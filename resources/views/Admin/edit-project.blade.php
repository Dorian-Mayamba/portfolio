...
@section('content')
    <div class="form-content">
        <h3 class="text-center"><small>Edit a project</small></h3>
        <form action="{{ route('create-project') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <textarea name="project_description" id="project_description" cols="30" rows="10"
                    class="form-control form-control-lg">{{ $project->project_description }}</textarea>
            ...
            <div class="form-group">
                <input type="text" class="form-control form-control-lg" name="poject_link" placeholder="Link" value="{{ $project->project_link }}">
                @error('project_link')
                    <div class="alert alert-danger">
                        <p><strong>{{ $message }}</strong></p>
                    </div>
            ...
            <div class="form-row">
                <div class="col-sm-2 offset-sm-5">
                    <input type="submit" value="Update" class="form-control form-control-lg btn btn-lg btn-info">
                </div>
            </div>
        </form>
    </div>
